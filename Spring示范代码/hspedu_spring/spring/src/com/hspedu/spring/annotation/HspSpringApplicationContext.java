...
//        System.out.println("resource1=" + resource1);
        ...
        if (file.isDirectory()) {
//            这里涉及递归的省略 万一文件夹套文件夹。。。省略了

            File[] files = file.listFiles();
            for (File f : files) {
                System.out.println("=====================");
                System.out.println("=" + f.getAbsolutePath());
                //我们获取到D:\hspedu_spring\spring\out\production\spring\com\hspedu\spring\component\UserService.class
                //我们需要的是 com.hspedu.spring.component.UserService
                ...
                if (fileAbsolutePath.endsWith(".class")) {
                    ...
                    try {
                        ...
                        //2. Class<?> aClass = classLoader.loadClass(classFullName); 也可以反射加载类
                        //3. 区别是 : 上面1方式后调用来类的静态方法, 下面2方法不会 一般建议用1方式
                        ...
                        if (aClass.isAnnotationPresent(Component.class) ||
                            ...
                            //StringUtils，这个是spring的工具类 用来处理字符串的
